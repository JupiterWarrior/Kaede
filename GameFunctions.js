...
async function guessNumber(message) {
        ...
        try {
            ...
            if (Number.isInteger(numberGuess) && numberGuess >= 1 && numberGuess <= 10) {
                ...
                if (numberGuess === correctNumber) {
                    ...
                    incorrectGuessString = "Nope! My number is lower! :stuck_out_tongue_closed_eyes: ";
                } else {
                    incorrectGuessString = "Nope! My number is higher! :stuck_out_tongue_closed_eyes: ";
                }
                if (guessesLeft == 2) {
    ...
    message.channel.send("Hehehe! I win! You're out of guesses <:02smug:683109333156102159>");
}